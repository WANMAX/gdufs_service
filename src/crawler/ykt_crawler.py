...
class YKTInformation(ComplexModel):
    ...
    def __init__(self, id, state, balance, transition_balance):
        self.id = id
        self.state = state
...
def crawl_ykt_information(cookie):
    ...
    id = table.find('div', text='帐        号：').findNext('td').text.strip()
    ...
    return YKTInformation(id, state, balance, transition_balance)
...
if __name__ == '__main__':
    ...
    print(crawl_history_account(cookie,"20150601", "20150701"))
